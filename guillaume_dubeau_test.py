...
Backend URL: https://firebug-hunter.preview.emergentagent.com/api
"""
...
class GuillaumeDubeauTester:
    def __init__(self):
        self.base_url = "https://firebug-hunter.preview.emergentagent.com/api/demo"
        self.headers = {}
        self.token = None
        self.credentials = {
            "email": "gussdub@gmail.com",
    ...
    def run_complete_investigation(self):
        ...
        print("🏢 Tenant: demo")
        print("🌐 URL: https://firebug-hunter.preview.emergentagent.com/api/demo")
