...
from routes.prevention_models import (
    ...
    ElementPlanBase, GazNaturelElement, GeneratriceElement,
    GeocodeRequest, GeocodeResponse,
    GrilleInspection, GrilleInspectionCreate,
    HydrantElement, IconePersonnalisee, IconePersonnaliseeCreate,
    Inspection, InspectionCreate,
    InspectionVisuelle, InspectionVisuelleCreate, InspectionVisuelleUpdate,
    MatiereDangereuse, NonConformite, NonConformiteCreate,
    NonConformiteVisuelle, NonConformiteVisuelleCreate,
    ParticipantInspection, PhotoBatiment, PhotoInspection,
    PhotoPlanIntervention, PlanEtage, PlanIntervention,
    PlanInterventionCreate, PlanInterventionUpdate,
    RejectionRequest, ReservoirPropaneElement, RouteAcces,
    SecteurGeographique, SecteurGeographiqueCreate, SecteurPlan,
    SortieElement, SymbolePersonnalise, SymbolePersonnaliseCreate,
    TemplatePlanIntervention, ValidationRequest, VehiculeElement, ZoneDanger,
