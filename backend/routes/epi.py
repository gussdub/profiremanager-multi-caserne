...
# ==================== HELPER POUR PUSH NOTIFICATIONS ====================

async def get_send_push_notification():
    """Récupère la fonction send_push_notification_to_users depuis notifications.py"""
    try:
        from routes import notifications as notif_module
        return notif_module.send_push_notification_to_users
