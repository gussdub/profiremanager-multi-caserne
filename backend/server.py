...
from routes.plan_intervention import router as plan_intervention_router
...
app.include_router(plan_intervention_router, prefix="/api")  # Module Plans d'intervention
