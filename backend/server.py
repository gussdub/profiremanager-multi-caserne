...
# ==================== DASHBOARD DONNÉES COMPLÈTES - MIGRÉ ====================
# Route migrée vers routes/dashboard.py:
# - GET /{tenant_slug}/dashboard/donnees-completes
# La fonction creer_activite est maintenant dans routes/dependencies.py
# =============================================================================
