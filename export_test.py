...
- URL de connexion: https://vehicle-inspection-3.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://vehicle-inspection-3.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
