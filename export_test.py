...
- URL de connexion: https://intervention-system-1.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://intervention-system-1.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
