...
- URL de connexion: https://pfm-transfer-import.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://pfm-transfer-import.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
