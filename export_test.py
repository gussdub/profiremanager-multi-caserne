...
- URL de connexion: https://mobile-inventory-35.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://mobile-inventory-35.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
