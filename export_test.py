...
- URL de connexion: https://deep-linking-mobile.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://deep-linking-mobile.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
