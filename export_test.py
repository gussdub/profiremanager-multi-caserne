...
- URL de connexion: https://fire-inquiry-portal.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://fire-inquiry-portal.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
