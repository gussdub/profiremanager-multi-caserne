...
- URL de connexion: https://emergency-tracker-18.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://emergency-tracker-18.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
