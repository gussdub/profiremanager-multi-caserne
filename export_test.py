...
- URL de connexion: https://prevention-module-qa.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://prevention-module-qa.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
