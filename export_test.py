...
- URL de connexion: https://camera-dashboard-fix.preview.emergentagent.com/pompiers-test
...
class ExportFunctionalityTester:
    def __init__(self):
        self.base_url = "https://camera-dashboard-fix.preview.emergentagent.com/api"
        self.headers = {}
        self.token = None
