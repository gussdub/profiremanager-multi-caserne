...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard-refonte">
      ...
      {console.log('Modal conditions:', { showUnifiedInspectionModal, hasSelectedEPI: !!selectedEPI, hasFormulaire: !!selectedFormulaireEPI, formulaireId: selectedEPI?.formulaire_avancee_id })}
