    ...
    <div className="parametres-harmonized">
      ...
      <div className="tab-content">
        ...
        {activeTab === 'remplacements' && (
          <Suspense fallback={<TabLoading />}>
            <ParametresRemplacements tenantSlug={tenantSlug} />
          </Suspense>
        )}

        {activeTab === 'disponibilites' && (
          <Suspense fallback={<TabLoading />}>
            <ParametresDisponibilites tenantSlug={tenantSlug} />
          </Suspense>
        )}

        {activeTab === 'formations' && (
          <Suspense fallback={<TabLoading />}>
            <ParametresFormations tenantSlug={tenantSlug} />
          </Suspense>
        )}

        {activeTab === 'imports' && (
          <Suspense fallback={<TabLoading />}>
            <ParametresImports tenantSlug={tenantSlug} />
          </Suspense>
        )}

        {activeTab === 'personnalisation' && (
          <Suspense fallback={<TabLoading />}>
            <ParametresPersonnalisation 
              tenantSlug={tenantSlug}
              typesGarde={typesGarde}
              competences={competences}
              grades={grades}
