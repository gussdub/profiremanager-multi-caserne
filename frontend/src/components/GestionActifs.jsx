  ...
  return (
    <div className="gestion-actifs" style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', borderBottom: '2px solid #ddd' }}>
        ...
        />
        <TabButton
          label="🔥 Inspections Bornes Sèches"
          active={activeTab === 'inspections-seches'}
          onClick={() => setActiveTab('inspections-seches')}
        />
        <TabButton
          label="📋 Inventaires"
      ...
      {loading ? (
        ...
        <div>
          ...
          ) : activeTab === 'inspections-seches' ? (
            <div style={{ padding: '20px', textAlign: 'center' }}>
              <h2>🔥 Inspections Bornes Sèches</h2>
              <p style={{ color: '#666', marginTop: '10px' }}>
                Module en cours de développement. Carte avec code couleur (rouge/orange/vert) et formulaire d'inspection 3 pages.
              </p>
            </div>
          ) : activeTab === 'epi' ? (
