        ...
        <div className="profil-main-column">
          ...
          <Card style={{ marginBottom: '1.5rem', overflow: 'hidden', position: 'relative', zIndex: 100 }}>
            ...
            <div style={{ 
              ...
              {/* Boutons et Menu */}
              <div className="photo-menu-container" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', position: 'relative', zIndex: 1000 }}>
                    ...
                    {userProfile?.tempSignature && (
                      <Button
                        onClick={async () => {
                          setSignatureUploading(true);
                          try {
                            // Convertir dataURL en blob de manière fiable
                            const dataUrl = userProfile.tempSignature;
