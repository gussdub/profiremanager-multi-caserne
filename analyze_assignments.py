...
def analyze_assignments():
    # Authentification
    auth_url = "https://smarter-forms.preview.emergentagent.com/api/demo/auth/login"
    ...
    assignations_url = "https://smarter-forms.preview.emergentagent.com/api/demo/planning/assignations/2025-12-01"
    ...
    users_url = "https://smarter-forms.preview.emergentagent.com/api/demo/users"
    ...
    types_url = "https://smarter-forms.preview.emergentagent.com/api/demo/types-garde"
    ...
    dispo_url = f"https://smarter-forms.preview.emergentagent.com/api/demo/disponibilites/{guillaume_id}"
    ...
    for assignation in assignations:
        ...
        dispo_url = f"https://smarter-forms.preview.emergentagent.com/api/demo/disponibilites/{user_id}"
        params = {"date_debut": "2025-12-01", "date_fin": "2025-12-01"}
        response = requests.get(dispo_url, headers=headers, params=params)
    ...
    params_url = "https://smarter-forms.preview.emergentagent.com/api/demo/parametres/remplacements"
