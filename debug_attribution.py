...
def test_attribution_with_logs():
    ...
    attribution_url = "https://firecalendar-fix.preview.emergentagent.com/api/demo/planning/attribution-auto"
    params = {
    ...
    if response.status_code == 200:
        ...
        if task_id:
            ...
            assignations_url = f"https://firecalendar-fix.preview.emergentagent.com/api/demo/planning/assignations/2025-12-01"
