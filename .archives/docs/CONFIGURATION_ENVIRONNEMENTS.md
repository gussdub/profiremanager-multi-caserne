...
- **URL Frontend** : https://role-based-ui-config.preview.emergentagent.com
- **URL Backend** : https://role-based-ui-config.preview.emergentagent.com/api
...
FRONTEND_URL="https://role-based-ui-config.preview.emergentagent.com"
```
