...
- **URL Frontend** : https://equipment-config.preview.emergentagent.com
- **URL Backend** : https://equipment-config.preview.emergentagent.com/api
...
FRONTEND_URL="https://equipment-config.preview.emergentagent.com"
```
